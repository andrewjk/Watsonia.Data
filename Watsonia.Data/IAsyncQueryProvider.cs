// Adapted from https://github.com/dotnet/efcore/blob/main/src/EFCore/Query/IAsyncQueryProvider.cs
...
namespace Watsonia.Data
{
    ...
    public interface IAsyncQueryProvider : IQueryProvider
    {
        ...
        ///     Executes the strongly-typed query represented by a specified expression tree asynchronously.
        /// </summary>
        TResult EnumerateAsync<TResult>(/*[NotNull]*/ Expression expression, CancellationToken cancellationToken = default);
#endif
    }
}
