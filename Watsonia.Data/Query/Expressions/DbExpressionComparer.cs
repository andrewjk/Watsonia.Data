...
namespace Watsonia.Data.Query.Expressions
{
    ...
    internal class DbExpressionComparer : ExpressionComparer
    {
        ...
        protected virtual bool CompareJoin(JoinExpression a, JoinExpression b)
        {
			...
			if (a.Join == ExpressionJoinType.CrossApply || a.Join == ExpressionJoinType.OuterApply)
            {
                var save = this.aliasScope;
                try
                {
        ...
        {
            return this.Compare(a.SelectExpression, b.SelectExpression);
        }
        ...
        {
            return this.Compare(a.Expression, b.Expression)
                && this.Compare(a.SelectExpression, b.SelectExpression)
        ...
        {
            if (!this.Compare(a.SelectExpression, b.SelectExpression))
                return false;
            ...
            {
                this.aliasScope = new ScopedDictionary<TableAlias, TableAlias>(this.aliasScope);
                this.aliasScope.Add(a.SelectExpression.Alias, b.SelectExpression.Alias);
