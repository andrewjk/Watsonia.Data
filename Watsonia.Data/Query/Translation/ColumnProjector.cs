			...
			if (this.candidates.Contains(expression))
			{
				if (expression.NodeType == (ExpressionType)DbExpressionType.Column)
				{
					...
					if (this.existingAliases.Contains(column.Alias))
					{
						...
						this.columns.Add(new ColumnDeclaration(columnName, column, column.Type));
				...
				else
				{
					...
					this.columns.Add(new ColumnDeclaration(columnName, expression, expression.Type));
		...
		class Nominator : DbExpressionVisitor
		{
			...
			protected override Expression Visit(Expression expression)
			{
				if (expression != null)
				{
					...
					this.isBlocked = false;
					if (this.MustBeColumn(expression))
					{
