		...
		protected override Expression VisitMemberAccess(MemberExpression m)
		{
			...
			if (ex != null && this.mapping.IsRelationship(ex.Entity, m.Member))
			{
				...
				if (this.currentFrom != null && this.mapping.IsSingletonRelationship(ex.Entity, m.Member))
				{
					...
					projection = OuterJoinTester.AddOuterJoinTest(projection);
					Expression newFrom = new JoinExpression(ExpressionJoinType.OuterApply, this.currentFrom, projection.SelectExpression, null);
