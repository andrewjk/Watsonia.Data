...
namespace Watsonia.Data.Tests.Cache
{
	...
	public class CacheTests
	{
		...
		public void TestItemCache()
		{
			...
			var value = cache.GetValues(7);
			Assert.AreEqual(5, cache.ItemsByAccessedTime[0]);
			Assert.AreEqual(6, cache.ItemsByAccessedTime[1]);
			Assert.AreEqual(8, cache.ItemsByAccessedTime[2]);
			Assert.AreEqual(9, cache.ItemsByAccessedTime[3]);
			Assert.AreEqual(10, cache.ItemsByAccessedTime[4]);
			Assert.AreEqual(24, cache.ItemsByAccessedTime[18]);
			Assert.AreEqual(7, cache.ItemsByAccessedTime[19]);
